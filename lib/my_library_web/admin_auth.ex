defmodule MyLibraryWeb.AdminAuth do
  use MyLibraryWeb, :verified_routes
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_my_library_web_admin_remember_me"
  ...
  the current_admin:
      ...
      defmodule MyLibraryWeb.PageLive do
        use MyLibraryWeb, :live_view

        on_mount {MyLibraryWeb.AdminAuth, :mount_current_admin}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{MyLibraryWeb.AdminAuth, :ensure_authenticated}] do
