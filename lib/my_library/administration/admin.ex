defmodule MyLibrary.Administration.Admin do
  use Ecto.Schema
  ...
  schema "admins" do
    ...
    has_one :admin_profile, MyLibrary.Administration.AdminProfile
  ...
  """
  def valid_password?(%MyLibrary.Administration.Admin{hashed_password: hashed_password}, password)
