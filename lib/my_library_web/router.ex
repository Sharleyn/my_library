defmodule MyLibraryWeb.Router do
  ...
  import MyLibraryWeb.AdminAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {MyLibraryWeb.Layouts, :root}
  ...
  if Application.compile_env(:my_library, :dev_routes) do
  ...
  scope "/", MyLibraryWeb do
    ...
    live_session :redirect_if_admin_is_authenticated,
      on_mount: [{MyLibraryWeb.AdminAuth, :redirect_if_admin_is_authenticated}] do
  ...
  scope "/", MyLibraryWeb do
    ...
    live_session :require_authenticated_admin,
      on_mount: [{MyLibraryWeb.AdminAuth, :ensure_authenticated}] do
  ...
  scope "/", MyLibraryWeb do
    ...
    live_session :current_admin,
      on_mount: [{MyLibraryWeb.AdminAuth, :mount_current_admin}] do
